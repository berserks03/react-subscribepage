...
const Api = () => {
  ...
  //   ProviderDataService.update(currentProvider.id, currentProvider)
  //     .then((response) => {
  //       console.log(response.data);
  //       retrieveProviders();
  //     })
      ...
      <div>
        ...
        >
          ...
          <div>
            ...
            />
            <button className='ml-10' type='button' onClick={searchByEmail}>
              Search
            </button>
          </div>
              ...
              <tbody>
                {!filteredProviders[0] ? (
                  ...
                  filteredProviders.map(
                    ({ id, email, provider, selected, date }, i) => {
                      return (
                        <tr key={id}>
          ...
          <button className='m-20' onClick={removeAllProviders}>
            Delete All
          </button>

          <a
            href='http://localhost:8085/api/file'
            className='m-20'
            role='button'
            style={{
              display: 'flex',
